...
public class MainPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.main_bottom_panel, new fragmentBottomPanel());
    ...
    public void listViewTest (){
        ...
        ListView mainPageListView = (ListView) findViewById(R.id.favourite_shop_list);
        ...
        mainPageListView.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        */
                        Intent intent = new Intent(MainPage.this ,ShopDetail.class);
                        startActivity(intent);
                    }
                }
        );
